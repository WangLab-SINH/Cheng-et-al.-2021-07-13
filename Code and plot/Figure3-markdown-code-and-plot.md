...
# 5
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Human_blood.csv',  19,233,"amplitude_expression_human_blood.pdf",
                     "Human blood","#FC8D62")
```
...
``` r
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Human_skin.csv',  19,94,"amplitude_expression_human_skin.pdf",
                     "Human skin","#FC8D62")
```
...
``` r
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Mouse_LIV.csv',  24,35,"amplitude_expression_mouse_liver.pdf", "Mouse liver","#FC8D62")
```
...
``` r
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Mouse_KID.csv',  24,35,"amplitude_expression_mouse_kidney.pdf",
                     "Mouse kidney","#FC8D62")
```
...
``` r
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Fly_old.csv',  24,35,"amplitude_expression_fly_old.pdf",
                     "Fly old","#FC8D62")
```
...
``` r
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Fly_young.csv',  24,35,"amplitude_expression_fly_young.pdf",
                     "Fly young","#FC8D62")
```
...
``` r
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Yeast_high.csv',  24,43,"amplitude_expression_yeast_high.pdf",
                     "Yeast high","#FC8D62")
```
...
``` r
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Yeast_low.csv',  24,47,"amplitude_expression_yeast_low.pdf",
                     "Yeast low","#FC8D62")
```
...
``` r
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Neurospora.csv',  19,90,"amplitude_expression_neurospora.pdf",
                     "Neurospora","#FC8D62")
```
...
``` r
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Arabidopsis_SD LEAF.csv',  24,35,"amplitude_expression_arabidopsis_sd leaf.pdf",
...
``` r
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Arabidopsis_SD M.csv',  24,35,"amplitude_expression_arabidopsis_sd m.pdf",
...
``` r
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Arabidopsis_SD VA.csv',  24,35,"amplitude_expression_arabidopsis_sd va.pdf",
...
``` r
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Chlamydomounas.csv',  19,34,"amplitude_expression_chlam.pdf",
                     "Green alga","#FC8D62")
```
...
``` r
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Cyanobacteria.csv',  19,38,"amplitude_expression_cyano.pdf",
...
``` r
draw_dotplot_exp_amp('All_meta2d_result/AllSpecies/Simulation.csv',  24,95,"amplitude_expression_cyano.pdf",
                     "Simulation","#FC8D62")
```
