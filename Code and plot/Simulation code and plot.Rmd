...
edge_go_dags = read.table("Simulation/edge_go_dags.txt",
                          stringsAsFactors = F)
vertex_go_dags = read.table("Simulation/vertex_go_dags.txt",
                            stringsAsFactors = F)
{
  mus_gomap = read.table("Simulation/mus_gomap.txt",
                         stringsAsFactors = F)
  mgi2ens = read.table("Simulation/MGI_to_ENSEMBL.txt",
